...
- **Bidirectional** — not read-only. **90 tools** span reading _and_ writing the canvas, so an agent can both implement designs and build them.
...
Figwright exposes **90 MCP tools** in three groups:
